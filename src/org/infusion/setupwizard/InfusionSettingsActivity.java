...
import static org.infusion.setupwizard.SetupWizardApp.DISABLE_NAV_KEYS;
import static org.infusion.setupwizard.SetupWizardApp.KEY_SEND_METRICS;
import static org.infusion.setupwizard.SetupWizardApp.KEY_DARK_THEME;
...
import org.infusion.setupwizard.R;

//import lineageos.hardware.LineageHardwareManager;
//import lineageos.providers.LineageSettings;

public class InfusionSettingsActivity extends BaseSetupWizardActivity {

    public static final String TAG = InfusionSettingsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String metricsHelpImproveInfusion =
                getString(R.string.services_help_improve_cm, getString(R.string.os_name));
        String metricsSummary = getString(R.string.services_metrics_label,
                metricsHelpImproveInfusion, getString(R.string.os_name));
        final SpannableStringBuilder metricsSpan = new SpannableStringBuilder(metricsSummary);
        metricsSpan.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD),
                0, metricsHelpImproveInfusion.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    protected int getLayoutResId() {
        return R.layout.setup_infusion_settings;
    }
